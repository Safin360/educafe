                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  foreach($row as $val){
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="slider-edit.php?id=<?php echo $val['id']; ?>" class="btn btn-success">Edit</a>
                        <a href="slider-view.php?id=<?php echo $val['id']; ?>" class="btn btn-info">View</a>
                        <a href="slider-delete.php?id=<?php echo $val['id']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                    <?php
                    $i++;
